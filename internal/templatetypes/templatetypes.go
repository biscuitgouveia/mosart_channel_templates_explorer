...
type Channel struct {
	...
	CommandOnTakeOutValue          int           `xml:"command_on_take_out_value,attr"`
	...
	CommandOnTakeValue             int           `xml:"command_on_take_value,attr"`
...
type RouterSetup struct {
	XMLName xml.Name `xml:"routersetup"`
	Setups  Setups   `xml:"setups"`
}

type Setups struct {
	XMLName xml.Name `xml:"setups"`
}

type Setup struct {
	XMLName         xml.Name `xml:"setup"`
	Matrix          int      `xml:"matrix,attr"`
	Level           int      `xml:"level,attr"`
	...
	ProgramDelay    int      `xml:"program_delay,attr"`
